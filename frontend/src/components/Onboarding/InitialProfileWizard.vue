...
.result-evidence-note { grid-column: 2; display: flex; align-items: center; flex-wrap: wrap; gap: 8px; border: 1px solid var(--line); border-radius: 8px; padding: 12px 14px; color: var(--muted); font-size: 11px; }
.result-evidence-note strong { color: var(--ink); }.result-evidence-note span { border-radius: 999px; background: var(--blue2); color: var(--blue); padding: 4px 8px; }.result-evidence-note small { flex-basis: 100%; line-height: 1.55; }
.result-route em { margin-left: 7px; border-radius: 5px; background: var(--blue2); color: var(--blue); padding: 2px 5px; font-size: 10px; font-style: normal; }
</style>
