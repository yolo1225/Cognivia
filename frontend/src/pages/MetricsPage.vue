...
.error-state { display: grid; justify-items: center; gap: 8px; padding: 48px 32px; border: 1px solid #fecaca; border-radius: 16px; background: var(--red2); color: var(--red); text-align: center; }.error-state p { color: inherit; font-size: 13px; }.error-state .btn { margin-top: 8px; }
...
.app.theme-dark .journey-hero { border-color: #3e5878; background: #1a2b41; }.app.theme-dark .journey-stats div { border-color: var(--line); background: var(--panel); }.app.theme-dark .timeline-card:hover,.app.theme-dark .timeline-card.expanded { border-color: #4b6fa9; }.app.theme-dark .resource-row { border-color: var(--line); }
