...
const questions: QuestionBankItem[] = [
  {
    ...
    answer: 0,
    explanation: "",
    source_ref_ids: ["chunk-rag"],
    source_quote: null,
    evidence_quotes: [],
    difficulty: 2,
    status: "active",
    certification_status: "certified",
    certification_rule_version: null,
    certified_at: null,
    certification_summary: { deterministic_passed: true, failed_fields: [], source_content_hash: null },
    disabled_at: null,
  ...
  },
  {
    ...
    certification_rule_version: null,
    certified_at: null,
    certification_summary: { deterministic_passed: null, failed_fields: [], source_content_hash: null },
    disabled_at: null,
    disabled_reason: null,
  },
];
