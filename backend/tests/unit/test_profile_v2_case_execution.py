...
from app.scripts.evaluate_profile_v2 import evaluate_profile_v2
...
def test_profile_v2_cases_match_frozen_algorithm_baseline() -> None:
...
def test_profile_v2_evaluation_uses_the_frozen_fixture_gate() -> None:
