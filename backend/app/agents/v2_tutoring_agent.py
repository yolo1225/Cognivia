"""Standalone V2 tutoring Agent with model understanding and deterministic policy."""
...
TUTORING_AGENT_NAME = "tutoring_agent_v2"
SYSTEM_PROMPT = (
...
class TutoringAgentError(RuntimeError):
    """Controlled boundary error for invalid V2 tutoring input or output."""
...
class V2TutoringAgent:
    """V2 boundary: model semantics -> controlled policy -> contract-validated response."""
