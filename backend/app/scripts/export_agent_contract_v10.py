...
OUTPUT_DIR = PROJECT_ROOT / "docs" / "contracts" / "v10"


def main() -> None:
    OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
    outputs = {
        OUTPUT_DIR / "agent-contract-v10.schema.json": AgentContractSchema.model_json_schema(),
        OUTPUT_DIR / "agent-contract-v10.examples.json": dump_example(
            {
