...
OUTPUT_DIR = PROJECT_ROOT / "docs" / "contracts" / "v8"


def main() -> None:
    OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
    outputs = {
        OUTPUT_DIR / "agent-contract-v8.schema.json": AgentContractSchema.model_json_schema(),
        OUTPUT_DIR / "agent-contract-v8.examples.json": dump_example(
            {
