...
## 20. 工业互联网定义与内涵
- **knowledge_id:** `sm.connectivity.001`
- **category:** 总览与体系
- **difficulty:** 1
...
## 21. 工业互联网体系架构2.0
- **knowledge_id:** `sm.connectivity.002`
- **category:** 总览与体系
- **difficulty:** 2
...
## 22. 网络、平台、安全三大功能体系
- **knowledge_id:** `sm.connectivity.003`
- **category:** 总览与体系
- **difficulty:** 1
...
## 23. 工业互联网网络体系
- **knowledge_id:** `sm.connectivity.004`
- **category:** 网络体系
- **difficulty:** 2
...
## 24. 工厂内网络与工业以太网
- **knowledge_id:** `sm.connectivity.005`
- **category:** 网络体系
- **difficulty:** 2
...
## 25. 5G+工业互联网
- **knowledge_id:** `sm.connectivity.006`
- **category:** 网络体系
- **difficulty:** 2
...
## 26. TSN 时间敏感网络
- **knowledge_id:** `sm.connectivity.007`
- **category:** 网络体系
- **difficulty:** 3
...
## 27. 工业互联网标识解析体系概述
- **knowledge_id:** `sm.connectivity.008`
- **category:** 标识解析
- **difficulty:** 2
...
## 28. 标识解析与产品追溯
- **knowledge_id:** `sm.connectivity.009`
- **category:** 标识解析
- **difficulty:** 2
...
## 31. IEC 61131-3 五种编程语言
- **knowledge_id:** `sm.plc.003`
- **category:** PLC基础
- **difficulty:** 2
...
## 62. OpenPLC Runtime v4 容器化部署与编辑器连接
- **knowledge_id:** `sm.simulation.openplc_runtime_v4.001`
- **category:** PLC 仿真与集成
- **difficulty:** 3
...
## 63. UR ROS 2 Driver 安装与实时通信边界
- **knowledge_id:** `sm.robot.ur_ros2_installation.001`
- **category:** 机器人仿真与集成
- **difficulty:** 3
...
## 64. URSim 与 UR ROS 2 Driver 联合仿真
- **knowledge_id:** `sm.robot.ursim_driver_simulation.001`
- **category:** 机器人仿真与集成
- **difficulty:** 3
...
## 65. UR ROS 2 Driver 启动与控制模式衔接
- **knowledge_id:** `sm.robot.ur_ros2_driver_startup.001`
- **category:** 机器人仿真与集成
- **difficulty:** 4
...
## 66. UR ROS 2 运动学校准提取与校验
- **knowledge_id:** `sm.robot.ur_calibration_validation.001`
- **category:** 机器人仿真与集成
- **difficulty:** 4
...
## 67. UR External Control 中断识别与恢复
- **knowledge_id:** `sm.robot.ur_external_control_recovery.001`
- **category:** 机器人仿真与集成
- **difficulty:** 4
